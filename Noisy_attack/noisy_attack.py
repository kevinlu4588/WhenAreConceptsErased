...
def parse_arguments():
    ...
    parser.add_argument("--results_file", type=str, default="./results/noisy_attack.txt", help="File to save results.")
    ...
    for method in args.methods:
        for concept in args.concepts:
            pipeline = StableDiffusionPipeline.from_pretrained(
                f"/share/u/kevin/ErasingDiffusionModels/final_models/{method}_{concept}",
