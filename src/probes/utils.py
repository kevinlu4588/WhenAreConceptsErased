    ...
    **kwargs,
    ...
    with self.progress_bar(total=num_inference_steps) as progress_bar:
        for i, t in enumerate(timesteps):
            ...
            dt_latents = latents['pred_original_sample']
            ...
            if callback_on_step_end is not None:
                ...
                dt_latents = callback_outputs.pop("dt_latents", dt_latents)
    ...
    if not output_type == "latent":
        image = self.vae.decode(dt_latents.to(latents.dtype) / self.vae.config.scaling_factor, return_dict=False, generator=generator)[
            0
        ]
